...
#labels_test['score'] = labels_test
#labels_test = labels_test.drop([0], axis = 1) 
...
classifier.fit(features_train, labels_train)
'''
from sklearn.linear_model import LogisticRegression        #0.84  #0.62     --> 0.7432 -->0.50
...
from sklearn.feature_extraction.text import CountVectorizer
cv = CountVectorizer(max_features = 5000)
features_test = cv.fit_transform(corpus_test).toarray()
